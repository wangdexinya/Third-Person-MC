...
<template>
    ...
    <div class="skin-preview-section">
      ...
      <div ref="previewContainer" class="skin-preview">
        ...
        <div class="rotate-controls">
          ...
          <button class="rotate-btn mc-button-pixel reset" @click="resetRotation">
            🔄
          </button>
  ...
  .mc-border {
    ...
    box-shadow:
      ...
      /* 底部和右侧阴影 */
      0 4px 0 0 rgba(0, 0, 0, 0.4) inset,
  ...
  .skin-card.selected {
    ...
    box-shadow:
      0 -2px 0 0 rgba(0, 0, 0, 0.5),
      -2px 0 0 0 rgba(0, 0, 0, 0.5),
      0 -4px 0 0 rgba(139, 195, 74, 0.4) inset,
      -4px 0 0 0 rgba(139, 195, 74, 0.4) inset,
      0 4px 0 0 rgba(0, 0, 0, 0.35) inset,
      4px 0 0 0 rgba(0, 0, 0, 0.35) inset;
  }
  ...
  .loading-spinner {
    ...
    background:
      ...
      linear-gradient(-45deg, transparent 40%, #8b8b8b 40%, #8b8b8b 60%, transparent 60%),
      #c6c6c6;
    box-shadow:
      0 -2px 0 0 rgba(0, 0, 0, 0.5),
      -2px 0 0 0 rgba(0, 0, 0, 0.5),
